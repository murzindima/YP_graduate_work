...
from core.messages import PERSONS_NOT_FOUND, PERSON_NOT_FOUND, PERSON_FILMS_NOT_FOUND
...
async def all_persons(
    ...
    persons = await person_service.get_all(person_filter)
...
async def person_films(
    ...
    films = await film_service.get_person_films(base_filter=base_filter, person_id=person_id)
    if not films:
